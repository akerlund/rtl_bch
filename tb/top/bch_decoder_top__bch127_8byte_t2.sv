module bch_decoder_top__bch127_8byte_t2 (
  input  logic clk,
  input  logic rst_n,
  output logic [bch_pkg::BCH127_8BYTE_T2_CFG_C.CODEWORD_BITS-1:0]        egr_corrected_codeword,
  output logic [$clog2(bch_pkg::BCH127_8BYTE_T2_CFG_C.T+2)-1:0]          egr_error_count,
