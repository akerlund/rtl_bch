module bch_syndrome_top__bch127_8byte_t2 (
  input  logic clk,
  input  logic rst_n,
  output logic [bch_pkg::BCH127_8BYTE_T2_CFG_C.M-1:0] egr_s1,
  output logic [bch_pkg::BCH127_8BYTE_T2_CFG_C.M-1:0] egr_s3,
